...
exports.getByCasebaseId = async (casebase_id) => {
  console.log('Diphtheria getByCasebaseId 👉', casebase_id);
...
exports.createDiphtheria = async (data) => {
  ...
  console.log("🔥 CREATE Diphtheria 👉", values);
...
exports.updateDiphtheria = async (casebase_id, disease_id, data) => {
  ...
  console.log("🔥 UPDATE Diphtheria 👉", values);
...
exports.deleteDiphtheria = async (casebase_id, disease_id) => {
  console.log("🔥 DELETE Diphtheria 👉", casebase_id, disease_id);

  await pool.query(
    `DELETE FROM tbl_diphtheria 
